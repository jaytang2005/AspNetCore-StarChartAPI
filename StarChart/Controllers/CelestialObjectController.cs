...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        public IActionResult GetById(int id)
        {
            ...
            celestialObject.Satellites = _context.CelestialObjects.Where(x => x.Id == id).ToList();
        ...
        public IActionResult GetByName(string name)
        {
            ...
            {
                celestialObject.Satellites = _context.CelestialObjects.Where(x => x.Id == celestialObject.Id).ToList();
            }
